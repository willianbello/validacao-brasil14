...
Suporte para o Angular 12, 13, 14 (Ainda não testado em outras versões mais antigas)

Este projeto foi testado somente com Angular 12, 13, 14 puro, mas não tem nenhuma dependência fora do próprio framework,
